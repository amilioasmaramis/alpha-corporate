...
export default function Fotographer() {
  return (
    <div>
      <div>
        <NavbarCareer />
            ...
            <div class="col-xl-7 col-lg-8">
              ...
              <div class="job-post-details">
                <div class="post-details1 mb-50">
                  ...
                  <p align="justify">
                    Apakah kamu merupakan seseorang yang menggemari seni?
                    Menyukai bidang komunikasi di bidang visual? Tertarik dengan
                    ilustrasi dan suka sekali menggambar? Mungkin dunia desain
                    grafis sangat cocok untukmu.
                  </p>
                </div>
                <div class="post-details2  mb-50">
                  ...
                  <ul>
                    <li>
                      Mengupload karya berupa 1 design feeds tentang Open
                      Recruitment yang diselenggarakan Alpha Creative Company ke
                      instagram.
                    </li>
                    <li>
